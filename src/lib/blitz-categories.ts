...
export const BLITZ_CATEGORIES: BlitzCategory[] = [
  {
    category_id: "car",
    target_word: "سيارة واير",
    correct_words: ["إطار", "محرك", "بنزين", "فرامل", "مقود", "مفتاح", "شاحن", "سائق", "رصيف", "واير"],
  ...
  },
  {
    ...
    correct_words: ["باب", "سطح", "دربونة", "بلكون", "عتبة", "ميز", "كرسي", "شاشة", "قنفة", "چرباية", "جام", "خزانة", "بردة", "سجادة", "مصباح"],
    blacklist: ["طابوق", "سمنت", "جص", "برغي", "بسامير", "شمعة", "كبريت"]
  },
  {
    category_id: "animals",
    target_word: "حيوانات برية ومفترسة",
  ...
  {
    category_id: "sky",
    target_word: "السماء والكون والفضاء",
  ...
  },
  {
    ...
    target_word: "الچاي وقعدة القهوة",
  ...
  },
  {
    ...
    blacklist: ["بيروت", "دمشق", "عمان", "القاهرة", "مكة", "لندن", "باريس", "بلد", "دولة", "قرية"]
  }
];

export const BLITZ_POOL_LABELS: Record<string, string> = {
  all: "جميع الفئات التراثية والعامة",
  iraqi: "لهجة وأكلات ومدن عراقية",
  nature_tools: "طبيعة، حيوانات، وأدوات عمل",
};
