...
export function GameOverScreen() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-[#0F172A]/72 p-4 backdrop-blur-md" dir="rtl">
      <div className="flex w-full max-w-sm flex-col justify-between rounded-2xl border-2 border-[#DC2626] bg-[#1E293B] p-6 text-[#F8FAFC] shadow-[0_0_20px_rgba(220,38,38,0.15)]">
