    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-sm" dir="rtl">
      <div className="w-full max-w-sm rounded-3xl border bg-[#1E293B] p-6 text-[#F8FAFC] shadow-2xl text-center flex flex-col items-center gap-5 border-white/10 animate-in fade-in zoom-in-95 duration-200">
        ...
        {isHost ? (
          ...
          <div className="w-full flex flex-col items-center justify-center gap-1.5 rounded-2xl bg-[#EF4444]/10 border border-[#EF4444]/20 p-4 text-center animate-pulse">
            <div className="flex items-center gap-2">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
              </span>
              <span className="text-sm font-black text-red-400">بانتظار المضيف لبدء لعبة جديدة...</span>
            </div>
            <p className="text-[11px] text-slate-400">يرجى الانتظار حتى يقوم المضيف بإعادة تشغيل اللعبة</p>
          </div>
        )}
      </div>
    </div>
